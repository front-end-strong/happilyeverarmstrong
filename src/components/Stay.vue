<template>
  <div class="stay" id="whereCanIStay">
    <div class="container">
      <h1 class="title">Where<br/>can<br/>I<span class="title--offset">stay</span></h1>
      <div class="stay__list">

        <div class="stay__option">
          ...
          <div class="stay__option__content">
            ...
            <span class="stay__option__callout">
              ...
              <p>Ask for Di and mention our names</p>
            </span>
          ...
          <a class="stay__option__button" href="http://blackspurinn.com.au/" target="_blank">book now</a>
        </div>
        ...
        <div class="stay__option">
          ...
          <div class="stay__option__content">
            ...
            <span class="stay__option__callout">
              ...
              <p>Ask for Kim and mention our names</p>
            </span>
          ...
          <a class="stay__option__button" href="https://www.saladinlodge.com.au/" target="_blank">book now</a>
        </div>
        ...
        <div class="stay__option">
          ...
          <div class="stay__option__content">
            ...
            <span class="stay__option__callout">
              ...
              <a href="https://www.groupon.com.au/deals/ga-vibe-hotel-marysville-5" target="_blank">Current Groupon Deal</a>
            </span>
          ...
          <a class="stay__option__button" href="https://vibehotels.com/hotel/marysville" target="_blank">book now</a>
        </div>
...
.stay {
  ...
  &__option {
    ...
    box-shadow: 0px 0px 50px rgba($black, 0.0);
